...
const bplayCaba = require('./caba/bplayCaba')

require('dotenv').config({ quiet: true });


const scriptCABA = async (playerData) => {
    ...
    try {
        ...
        const promises = [
            bplayCaba(pageBplay, playerData), // <--- playerData llega desde una request http
