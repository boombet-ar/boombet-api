...
const pageUrl = process.env.BPLAY_CBA_URL

const bplayCba = async (page, playerData) => {
    const meses = [
    ...
    try {
        ...
        const provinciaNombre = 'Cordoba' //toTitleCase(provincia).trim();
